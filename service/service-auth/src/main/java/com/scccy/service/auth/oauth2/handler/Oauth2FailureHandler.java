package com.scccy.service.auth.oauth2.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.scccy.common.modules.dto.ResultData;
import com.scccy.service.auth.exception.AuthErrorType;
...
public class Oauth2FailureHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception)
        ...
        response.getWriter().write(new ObjectMapper().writeValueAsString(ResultData.fail(AuthErrorType.UNAUTHORIZED, message)));
