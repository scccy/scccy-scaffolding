...
import com.scccy.common.modules.domain.BaseForm;
...
@Schema
@Data
public class RegisteredClientForm extends BaseForm<Oauth2RegisteredClientMp> {
    ...
    @Override
    public Oauth2RegisteredClientMp toPo(Class<Oauth2RegisteredClientMp> clazz) throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        Oauth2RegisteredClientMp registeredClientPo = super.toPo(clazz);
