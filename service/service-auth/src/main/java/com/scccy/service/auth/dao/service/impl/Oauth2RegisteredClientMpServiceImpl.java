...
import com.scccy.service.auth.dao.service.Oauth2RegisteredClientMpService;
...
/**
 * client记录表(Oauth2RegisteredClient)服务实现类
 *
 * @author scccy
 * @since 2025-11-01 14:03:12
 */
@Service
public class Oauth2RegisteredClientMpServiceImpl
        extends ServiceImpl<Oauth2RegisteredClientMapper, Oauth2RegisteredClientMp>
        implements Oauth2RegisteredClientMpService {
    /**
     * cache prefix key
     */
