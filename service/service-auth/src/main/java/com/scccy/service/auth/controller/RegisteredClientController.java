...
import com.scccy.service.auth.domain.form.RegisteredClientQueryForm;
...
public class RegisteredClientController {
    ...
    @ApiResponses(
            @ApiResponse(responseCode = "200", description = "处理成功", content = @Content(schema = @Schema(implementation = ResultData.class)))
    )
    @GetMapping
    ...
    public IPage<RegisteredClientVo> search(@Parameter(description = "客户端查询参数", required = true) @Valid @RequestBody RegisteredClientQueryForm registeredClientQueryForm) throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
